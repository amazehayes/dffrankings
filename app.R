...
colnames(rankings) <- c("Player","Pos","Team","Consensus","Cipes","Crandall","Hayes",
                        ...
                        "Stephenson","Player","Pos","Team","Consensus","Halupka","Swager","Manila",
                        "Soukup","Player","Pos","Team","Consensus","Cook","Orr",
...
ui <- dashboardPage(skin = "black",
  ...
  dashboardSidebar(
    ...
    menuItem("Superflex Rankings", tabName = "superflex", icon = icon("table")),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "superflex",
              fluidRow(
                column(4,selectInput("positionC", "Choose Position:",
                                     choices = c("All","QB","RB","WR","TE")))),
              fluidRow(style = "overflow-x: scroll; font-size: 12px",DT::dataTableOutput("superflex"))),
      tabItem(tabName = "idp",
              fluidRow(
